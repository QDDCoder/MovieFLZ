...
import 'package:movie_flz/tools/normal_video/tv.dart';
import 'package:movie_flz/tools/normal_video/widget/myBottomSheet.dart';
...
class _VideoPlayerUIState extends State<VideoPlayerUI> {
  ...
  void _videoListener() async {
    ...
    } else if (DateTime.now().difference(_tempTime).inMilliseconds > 999) {
