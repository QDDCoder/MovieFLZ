...
import 'package:movie_flz/tools/normal_video/widget/myRoundButton.dart';
import 'package:movie_flz/tools/normal_video/widget/myText.dart';

class TV extends StatefulWidget {
  final String video_name;
  final String video_play_link;

  TV({this.video_name, this.video_play_link});
  @override
...
class _TVState extends State<TV> {
  ...
  Future<void> init() async {
    ...
    _didlObject = VideoObject(
        widget.video_name, widget.video_play_link, VideoObject.VIDEO_MP4);
