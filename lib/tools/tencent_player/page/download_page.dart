        ...
        child: Row(
          ...
          children: <Widget>[
              ...
              children: <Widget>[
                Row(
                  children: <Widget>[
                    ...
                    value != null
                        ? Text(
                            '${((value.downloadSize) / 1024 / 1024).toStringAsFixed(2)}M/${((value.size) / 1024 / 1024).toStringAsFixed(2)}M')
                        : SizedBox(),
                  ],
                ),
                SizedBox(
                        ...
                        onTap: () {
                          Navigator.of(context).push(CupertinoPageRoute(
                              builder: (_) => FullVideoPage(
                                    playType: PlayType.file,
                                    dataSource: value?.playPath,
                                    showClearBtn: false,
                                  )));
                        },
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              border: Border.all(
                                  width: 1, color: Color(0xfffe373c)),
                              borderRadius:
            ...
            GestureDetector(
              ...
              child: Text(
                getBtnTxt(value?.downloadStatus ?? ''),
